            ...
            <div className={styles.daily_report_filters}>
              <div className={styles.date_picker}>
                <div 
                  ...
                  style={{width: '180px', margin: 0, position: 'relative'}}
                >
                   <div className={styles.report_filter_toggle}>
              ...
              <div className={styles.employee_select} ref={dropdownRef}>
                <div 
                  className={styles.custom_dropdown} 
                  style={{width: '200px', margin: 0}}
                >
                  <div 
                    className={styles.report_filter_toggle}
