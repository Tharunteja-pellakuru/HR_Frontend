...
const LeaveRejectList = () => {
    const [searchTerm, setSearchTerm] = useState("");
    const [showReasonModal, setShowReasonModal] = useState(false);
    const [selectedLeave, setSelectedLeave] = useState(null);

    const leaveRequests = [
        { sno: "0001", name: "Ashritha", startDate: "25-01-2025", endDate: "28-01-2025", days: "4.0" },
        { sno: "0002", name: "Chaitanya", startDate: "16-02-2025", endDate: "17-02-2025", days: "2.0" },
        { sno: "0003", name: "Kunal", startDate: "20-01-2025", endDate: "22-01-2025", days: "3.0" },
        { sno: "0004", name: "Lokesh", startDate: "31-02-2025", endDate: "02-02-2025", days: "3.0" },
        { sno: "0005", name: "Jagadeesh", startDate: "18-01-2025", endDate: "19-01-2025", days: "1.0" },
        { sno: "0006", name: "Shayam", startDate: "17-01-2025", endDate: "17-01-2025", days: "1.0" },
    ];
            ...
            <div className={styles.admin_dashboard_main}>
                ...
                <div className={styles.dashboard_content}>
                    ...
                    <div className={styles.leave_header_row}>
                        <h2 className={styles.pageTitleWithLine}>Leave Reject List</h2>
                                    ...
                                    <tr key={idx} className={styles.data_row}>
                                        ...
                                        <td>
                                            <button 
                                                ...
                                                className={styles.reason_btn_red}
                                            >
                                                Reason
                                            </button>
                                        </td>
...
export default LeaveRejectList;
