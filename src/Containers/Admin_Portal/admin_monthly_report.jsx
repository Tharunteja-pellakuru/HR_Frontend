        ...
        <div className={styles.dashboard_content}>
          ...
          <div className={styles.monthDashboard}>
            <div className={styles.sectionHeader}>
              Month : <span className={styles.monthName}>{selectedMonth || "January"}</span>
            </div>
              ...
              <div className={styles.statCard} style={{ position: 'relative', overflow: 'hidden', margin: '0', padding: '20px 8px' }}>
                <div style={{ width: '100%', height: '140px', position: 'relative', marginTop: '-15px' }}>
                  <ResponsiveContainer>
                    <PieChart>
                      <Pie
                        data={[{ value: attendanceRate }, { value: 100 - attendanceRate }]}
                        dataKey="value"
                        cx="50%"
                        cy="80%"
                        startAngle={180}
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      transform: `rotate(${-180 + (180 * attendanceRate / 100)}deg)`,
              ...
              <div className={styles.statCard} style={{ position: 'relative', overflow: 'hidden', margin: '0', padding: '20px 8px' }}>
                <div style={{ width: '100%', height: '140px', position: 'relative', marginTop: '-15px' }}>
                  <ResponsiveContainer>
                    <PieChart>
                      <Pie
                        data={[{ value: avgHoursWorked }, { value: 7 - avgHoursWorked }]}
                        dataKey="value"
                        cx="50%"
                        cy="80%"
                        startAngle={180}
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      left: '0',
                      transformOrigin: 'left center',
                      transform: `rotate(${-180 + (180 * avgHoursWorked / 7)}deg)`,
                      clipPath: 'polygon(0 0, 100% 50%, 0 100%)',
                      zIndex: 5
                    }}></div>
                    <div style={{
